...
public class C03_Cookies extends TestBase {
    ...
    public void test01() {
        ...
        for (Cookie eachCookie:cookiesSeti
            ...
            if (eachCookie.getName().equals("i18n-prefs")){ // name'i şuysa valuesini al
                actualCookieDegeri=eachCookie.getValue(); // actual cookie degerine gelen cookinin valuesini al
            }
        }
        ...
        driver.manage().addCookie(benimCookie); // eklemek

        cookiesSeti= driver.manage().getCookies(); // gormek
        siraNo=1;
        for (Cookie eachCookie:cookiesSeti
        ) {
            System.out.println(siraNo +"- " + eachCookie);
